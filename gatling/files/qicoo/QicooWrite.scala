...
class QicooWrite extends Simulation {
    ...
    object Configuration {
        var SCENARIO_NAME_POST = "Qicoo Write"
        ...
        val USERS_POST : Long = java.lang.Long.valueOf(System.getProperty("users_post", "12"))
        val USERS_LIKE : Long = java.lang.Long.valueOf(System.getProperty("users_like", "12"))
