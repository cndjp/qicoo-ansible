...
${ANSIBLE_CTL} ${ALLUP_ZENBU_FLAG} /home/qicoo/qicoo-ansible/aws/create-rds-instance.yml >> ${ALLUP_LOG_FILE}
${ANSIBLE_CTL} ${ALLUP_ZENBU_FLAG} /home/qicoo/qicoo-ansible/aws/create-elasticache-cluster.yml >> ${ALLUP_LOG_FILE}
