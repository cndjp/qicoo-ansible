...
${ANSIBLE_CTL} /home/qicoo/qicoo-ansible/aws/create-rds-instance.yml ${ALLUP_ZENBU_FLAG} >> ${ALLUP_LOG_FILE}
${ANSIBLE_CTL} /home/qicoo/qicoo-ansible/aws/create-elasticache-cluster.yml ${ALLUP_ZENBU_FLAG} >> ${ALLUP_LOG_FILE}
...
hal deploy apply -q >> ${ALLUP_LOG_FILE}
